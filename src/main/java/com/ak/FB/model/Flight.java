...
public class Flight {
    ...
    public Flight(Long id, String flight_no, String name, int capacity, String seats, Integer from_city_id, Integer to_city_id, Integer price) {
        this.id = id;
    ...
    public Flight(String flight_no, String name, int capacity, String seats, Integer from_city_id, Integer to_city_id, Integer price, LocalDate departure_date, LocalTime departure_time, LocalDate arrival_date, LocalTime arrival_time) {
        this.flight_no = flight_no;
        this.name = name;
        this.capacity = capacity;
        this.seats = seats;
