...
public class Bookings {
    ...
    public Bookings(){}
    public Bookings(Integer member_id, Long traveler_id, Integer flight_id, String ticketno, LocalDate date,String seatno, LocalTime time, Integer price, Integer from_city_id, Integer to_city_id) {
    ...
    public Bookings(Long id, Integer member_id, Long traveler_id, Integer flight_id, String ticketno, String seatno, Integer price, Integer from_city_id, Integer to_city_id) {
        this.id = id;
        this.member_id = member_id;
        this.traveler_id = traveler_id;
        this.flight_id = flight_id;
